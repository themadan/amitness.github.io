...
Cover: /images/sela-pipeline-enabled.png
...
<pre class="math">
p(y=.|x_i) = softmax( \textcolor{#3b6eb5}{h\ o\ \phi(}x_i \textcolor{#3b6eb5}{)} )
</pre>
