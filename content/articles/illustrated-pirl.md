...
![Transformations present in PreText tasks of Self-Supervised Learning](/images/pirl-geometric-pretext-tasks.png){.img-center}
...
![Standard Setup Used in Pretext tasks](/images/pirl-generic-pretext-setup.png){.img-center}
...
![Idea of PIRL Framework](/images/pirl-covariant-representation.png){.img-center}
...
![Intuitive Example of PIRL concept](/images/pirl-concept.png){.img-center}
...
![End to End Pipeline of PIRL Framework](/images/pirl-general-architecture.png){.img-center}
...
![Disadvantage of using images in current batch as negative pair](/images/pirl-batch-size-negative-pair.png){.img-center}
...
![Working mechanism of caching in memory bank](/images/pirl-memory-bank.png){.img-center}  
...
![Single batch of images in PIRL](/images/pirl-single-batch.png){.img-center}  
...
![Example of Rotation Prediction task](/images/pirl-rotation-gif.gif){.img-center}  
Thus, for 2 images in our batch, we get two pairs and total four images.
![Example of pairs in a batch of images](/images/pirl-augmented-pairs-batch.png){.img-center}
**4. Encoder**  
...
![The Encoder Component of PIRL](/images/pirl-encoder.png){.img-center}  
**5. Projection Head**  
...
![Projection head component of PIRL Framework](/images/pirl-projection-head.png){.img-center}  
...
![Embeddings outputted by the projection head components](/images/pirl-batch-outputs.png){.img-center}  
...
![Calculation of cosine similarity of two images](/images/pirl-cosine-similarity.png){.img-center}  
...
![Noise Contrastive Estimation Loss of two images](/images/pirl-nce-calculation.png){.img-center}
...
![Softmax calculation on similarity of two images](/images/pirl-nce-formula-parts.png){.img-center}
...
![Ideal outputs from Noise Contrastive Estimator Loss](/images/pirl-ideal-nce.png){.img-center}
<pre class="math">
...
![Two components of the PIRL loss function](/images/pirl-final-loss-visualization.png){.img-center}
